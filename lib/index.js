...
class ScrollableTabView extends Component {
  ...
  componentWillReceiveProps(props) {
    ...
    if (props.tabHeights && props.tabHeights[this.state.currentPage]) {
      const newHeight = this.collapsableBarHeight + props.tabHeights[this.state.currentPage] < height ? height : this.collapsableBarHeight + props.tabHeights[this.state.currentPage] + statusBarHeight + 30;
    ...
    if (this.props.collapsableBar) {
      ...
      setTimeout(() => {
        if (this.props.tabHeights && this.props.tabHeights[currentPage]) {
          const newHeight = this.collapsableBarHeight + this.props.tabHeights[currentPage] < height ? height : this.collapsableBarHeight + this.props.tabHeights[currentPage] + statusBarHeight + 30;
          this.setState({ height: newHeight })
        }
  ...
  render() {
    ...
    const statusBarHeight = this.props.statusBarHeight || 0
    const height = isScrollView && this.state.height || isScrollView && Dimensions.get('window').height - statusBarHeight + (this.collapsableBarHeight || 0)
